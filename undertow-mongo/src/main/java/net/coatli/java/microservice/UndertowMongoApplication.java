...
import net.coatli.java.microservice.config.MongoDb;
 ...
 */
public class UndertowMongoApplication {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    try (InputStream inputStream = UndertowMongoApplication.class.getResourceAsStream(APPLICATION_PROPERTIES)) {
